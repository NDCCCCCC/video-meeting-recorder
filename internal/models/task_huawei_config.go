...
type TaskHuaweiConfig struct {
	...
	TaskID         uint      `gorm:"not null;index:idx_task_config;index:idx_task_huawei_config;uniqueIndex:idx_task_huawei_config_unique" json:"task_id"`
	HuaweiConfigID uint      `gorm:"not null;index:idx_task_config;index:idx_huawei_config;uniqueIndex:idx_task_huawei_config_unique" json:"huawei_config_id"`

...
- [x] **Phase 2: Local Transcription** - Frame extraction, SSIM/pHash/edge detection, and PPTX generation
...
Plans:
- [x] 04-01-PLAN.md — Backend foundation: OSSService, TingwuClient, config extensions, model extensions (Mode/CloudTaskID/OSSURL), TranscriptionText model
- [x] 04-02-PLAN.md — Frontend types, API client with mode parameter, TranscriptionProgressModal cloud stage adaptation
- [x] 04-03-PLAN.md — Backend pipeline: TranscriptionService cloud branch with fallback, handler mode parameter, text content endpoint, app.go wiring
- [x] 04-04-PLAN.md — Frontend integration: Dropdown transcription buttons, TextContentTab component, result page tabs and retranscribe dropdown
- [x] 04-05-PLAN.md — Gap closure: Replace OSS stub with real OSS SDK v2 implementation (UploadFile, SetLifecycleRule, DeleteFile)
...
| 2. Local Transcription | 4/4 | Complete | 2026-04-18 |
| 3. PPT Management | 2/2 | Planned | 2026-04-17 |
| 4. Cloud Services | 4/5 | Gap Closure | - |

---
*Roadmap created: 2026-04-17*
*Last updated: 2026-04-18 after gap closure plan for OSS implementation*

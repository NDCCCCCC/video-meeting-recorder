...
- [x] 01-03-PLAN.md — Frontend split page with TimelineWithMarkers + split API client
- [x] 01-04-PLAN.md — Task list snapshot button + file list source column + auto-refresh
